...
def attack(char_name: str, char_class: str) -> str:
    """Calculates damage caused by selected character."""
...
def defence(char_name: str, char_class: str) -> str:
    """Calculates damage blocked by selected character."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Using of special skill by selected character."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Lets the user to select a character."""
...
if __name__ == '__main__':
    ...
    print(start_training(char_name, char_class))  # type: ignore
